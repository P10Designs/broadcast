let data; let visitorPlayers; let localPlayers; let local; let visitor; let runningTime = false; let ms = 100
...
async function genView () {
  ...
  bottom.innerHTML += `<div class="team">
    <div class="top">
      <img src="${local.logo}" />
  ...
  <input id="time" value="1:30" style="display:none;"></input>
      <div class='top'>
        <div class="result">
      ...
      <button class='period'>1st</button>
      <div class='mid'></div>
      <div class='bot'>
